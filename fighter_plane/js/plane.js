...
orangePlaneImg.src = '/images/plan.png'; // Replace with actual path
const whitePlaneImg = new Image();
whitePlaneImg.src = '/images/plan.png'; // Replace with actual path
const greenPlaneImg = new Image();
greenPlaneImg.src = '/images/plan.png'; // Replace with actual path

// Load Ashoka Chakra image as HTML img element
const chakraImg = new Image();
chakraImg.src = '/images/ashoka-chakra.png'; // Replace with actual path
...
function updatePosition(plane) {
    ...
    if (
        ...
        playAudio('/images/super_sonic_boom.mp3', 0.02, 2); // Adjust volume and speed accordingly
    }
